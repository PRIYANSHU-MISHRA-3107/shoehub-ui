  ...
  {[
    ...
    <li key={i} className="group cursor-pointer relative">
      ...
      <div className="absolute inset-0 pointer-events-none animate-pulse opacity-20">
        <div className="absolute w-[500px] h-[500px] rounded-full bg-orange-500 blur-[250px] -top-40 -left-40"></div>
        <div className="absolute w-[500px] h-[500px] rounded-full bg-orange-500 blur-[250px] -bottom-40 right-10"></div>
      </div>
